...
class AdaptiveLearningRoutes {
  ...
  initializeRoutes() {
    ...
    /**
     * @route   GET /api/adaptive/qlearning/export.csv
     * @desc    Export persisted Q-values as CSV
     * @access  Private (authenticated - for research)
     */
    this.router.get(
      '/qlearning/export.csv',
      this.controller.exportQValuesCSV.bind(this.controller)
    );

    /**
     * @route   GET /api/adaptive/qlearning/transitions.csv
     * @desc    Export adaptive state transitions as CSV (supports filters)
     * @access  Private (authenticated - for research)
     */
    this.router.get(
      '/qlearning/transitions.csv',
      this.controller.exportTransitionsCSV.bind(this.controller)
    );
    ...
    /**
     * @route   POST /api/adaptive/generate-explanation
