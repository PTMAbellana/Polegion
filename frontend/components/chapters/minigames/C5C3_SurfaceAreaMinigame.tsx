...
const C5C3_SurfaceAreaMinigame: React.FC<Props> = ({ question, onComplete, styleModule }) => {
        ...
        <div className={styleModule.canvasContainer}>
          <div className={styleModule.canvasWrapper}>
            <div style={{ padding: 12 }}>
              <div className={styleModule.hint}>Use the surface area formula for the given solid.</div>
