...
import { FaHome, FaChalkboardTeacher, FaUserAstronaut, FaFortAwesome, FaShapes, FaBrain, FaRobot, FaDumbbell, FaChartLine } from 'react-icons/fa';
...
export const studentNavItems = [
    ...
    { path: STUDENT_ROUTES.ANALYTICS, icon: FaChartLine, label: 'Analytics', title: 'Learning Analytics' },
