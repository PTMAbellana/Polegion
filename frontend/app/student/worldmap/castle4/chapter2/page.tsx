...
const CHAPTER_KEY = 'castle4-chapter2';
...
export default function Castle2Chapter1Page() {
    ...
    const fetchQuizScore = async () => {
      if (currentScene === 'reward' && quiz?.id) {
        try {
          ...
          console.log('[castle4-chapter2] Fetched quiz attempts:', attempts);
          ...
          if (attempts && attempts.length > 0) {
            ...
            console.log('[castle4-chapter2] Most recent quiz score:', mostRecentScore);
  ...
  React.useEffect(() => {
    // Castle 4 Chapter 2 has 6 lesson concepts with semantic keys
  ...
  function handleDialogueComplete() {
    if (currentScene === 'opening') {
      ...
      playNarration('castle4-chapter2-lesson-intro');
    ...
    if (userAnswer === question.correctAnswer) {
      ...
      setTimeout(() => {
        ...
        if (quizNumber === 1) {
          ...
          // Submit quiz attempt
          try {
            console.log('[castle4-chapter2] Submitting quiz with answers:', quizAnswers);
            console.log('[castle4-chapter2] Quiz config:', quiz.quiz_config);
          ...
          {currentScene === 'minigame' && (
            <ShapeBasedMinigame
              question={{
                ...
                correctAnswer: CHAPTER2_MINIGAME_LEVELS[currentMinigameLevel].polygonType,
