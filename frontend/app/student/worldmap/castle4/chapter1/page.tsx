...
const CHAPTER_KEY = 'castle4-chapter1';
...
export default function Castle2Chapter1Page() {
    ...
    const fetchQuizScore = async () => {
      if (currentScene === 'reward' && quiz?.id) {
        try {
          ...
          console.log('[castle4-chapter1] Fetched quiz attempts:', attempts);
          ...
          if (attempts && attempts.length > 0) {
            ...
            console.log('[castle4-chapter1] Most recent quiz score:', mostRecentScore);
  ...
  React.useEffect(() => {
    // Castle 4 Chapter 1 has 6 lesson concepts with semantic keys
  ...
  function handleDialogueComplete() {
    if (currentScene === 'opening') {
      ...
      playNarration('castle4-chapter1-lesson-intro');
    ...
    if (userAnswer === question.correctAnswer) {
      ...
      setTimeout(() => {
        ...
        if (quizNumber === 1) {
          ...
          // Submit quiz attempt
          try {
            console.log('[castle4-chapter1] Submitting quiz with answers:', quizAnswers);
            console.log('[castle4-chapter1] Quiz config:', quiz.quiz_config);
          ...
          {currentScene === 'minigame' && (
            <ShapeBasedMinigame
              question={{
                ...
                correctAnswer: String(CHAPTER1_MINIGAME_LEVELS[currentMinigameLevel].correctAnswer),
                sides: CHAPTER1_MINIGAME_LEVELS[currentMinigameLevel].sides,
