...
const CHAPTER_KEY = 'castle3-chapter3';
...
export default function Castle2Chapter1Page() {
    ...
    const fetchQuizScore = async () => {
      if (currentScene === 'reward' && quiz?.id) {
        try {
          ...
          console.log('[castle3-chapter3] Fetched quiz attempts:', attempts);
          ...
          if (attempts && attempts.length > 0) {
            ...
            console.log('[castle3-chapter3] Most recent quiz score:', mostRecentScore);
  ...
  React.useEffect(() => {
    // Castle 3 Chapter 3 has 6 lesson concepts with semantic keys
  ...
  function handleDialogueComplete() {
    if (currentScene === 'opening') {
      ...
      playNarration('castle3-chapter3-lesson-intro');
    ...
    if (userAnswer === question.correctAnswer) {
      ...
      setTimeout(() => {
        ...
        if (quizNumber === 1) {
          ...
          // Submit quiz attempt
          try {
            console.log('[castle3-chapter3] Submitting quiz with answers:', quizAnswers);
            console.log('[castle3-chapter3] Quiz config:', quiz.quiz_config);
          ...
          {currentScene === 'minigame' && (
            <AreaCalculationMinigame
              question={{
                ...
                radius: CHAPTER3_MINIGAME_LEVELS[currentMinigameLevel].radius,
