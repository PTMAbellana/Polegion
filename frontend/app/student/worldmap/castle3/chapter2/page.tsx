...
const CHAPTER_KEY = 'castle3-chapter2';
...
export default function Castle2Chapter1Page() {
    ...
    const fetchQuizScore = async () => {
      if (currentScene === 'reward' && quiz?.id) {
        try {
          ...
          console.log('[castle3-chapter2] Fetched quiz attempts:', attempts);
          ...
          if (attempts && attempts.length > 0) {
            ...
            console.log('[castle3-chapter2] Most recent quiz score:', mostRecentScore);
  ...
  React.useEffect(() => {
    // Castle 3 Chapter 2 has 6 lesson concepts with semantic keys
  ...
  function handleDialogueComplete() {
    if (currentScene === 'opening') {
      ...
      playNarration('castle3-chapter2-lesson-intro');
    ...
    if (userAnswer === question.correctAnswer) {
      ...
      setTimeout(() => {
        ...
        if (quizNumber === 1) {
          ...
          // Submit quiz attempt
          try {
            console.log('[castle3-chapter2] Submitting quiz with answers:', quizAnswers);
            console.log('[castle3-chapter2] Quiz config:', quiz.quiz_config);
    ...
    <div className={`${baseStyles.chapterContainer} ${baseStyles.castle3Theme}`}>
      ...
      {showProgressModal && (
        <ChapterProgressModal
          chapterTitle="Chapter 2: The Hall of Rays"
      ...
      <ChapterTopBar
        chapterTitle="Chapter 2: The Hall of Rays"
        chapterSubtitle="Castle 3 - Angles Sanctuary"
        isMuted={isMuted}
        autoAdvance={autoAdvanceEnabled}
          ...
          {currentScene === 'minigame' && (
            <PerimeterMinigame
              question={{
                ...
                instruction: CHAPTER2_MINIGAME_LEVELS[currentMinigameLevel].instruction,
                correctAnswer: CHAPTER2_MINIGAME_LEVELS[currentMinigameLevel].correctAnswer,
                radius: CHAPTER2_MINIGAME_LEVELS[currentMinigameLevel].radius ?? undefined,
                diameter: CHAPTER2_MINIGAME_LEVELS[currentMinigameLevel].diameter ?? undefined,
