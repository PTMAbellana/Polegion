...
VALUES 
  ('0ca43969-e6d1-4e96-ad84-3adf46bcd9dd', 'The Euclidean Spire', 'Master the foundations of geometry. Learn about points, lines, angles, and basic shapes.', 'Easy', 'Northern Plains', 'castle1', 1, 500, 1),
  ('bdfc1a9f-cd2a-4c1a-9062-9f99ec41e008', 'The Polygon Citadel', 'Journey through the enchanted forest of shapes. Master polygon identification, perimeter calculations, and area formulas.', 'Medium', 'Emerald Forest', 'castle2', 2, 750, 2),
  ('d6e7a642-5d4c-4f9e-8b3a-1c2d3e4f5a6b', 'Circle Sanctuary', 'Enter the sacred halls where eternal curves hold ancient secrets. Master the parts of circles, circumference, and area calculations.', 'Medium', 'Golden Shores', 'castle3', 3, 800, 3)
